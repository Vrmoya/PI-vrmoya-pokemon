...
import style from '../CreatePokemon/PokemonCreate.module.scss'
...
const createPokemon = () => {
    ...
    const pokemons = useSelector(state => state.pokemons.map( pok => pok.name))
...
// import { Link,  } from 'react-router-dom';
// import { useDispatch, useSelector } from 'react-redux';
// import { postPokemon, getTypes, getPokemons } from '../../redux/';
