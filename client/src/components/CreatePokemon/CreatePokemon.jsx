...
//     console.log(validationErrors); // Utiliza el estado actualizado directamente
//     setErrors(validationErrors);
//   };
...
//   const handleSubmit = (event) => {
//     event.preventDefault();
//     console.log("Estado de newPokemon antes de la validación:", newPokemon);
//     console.log("Errores antes de la validación:", errors);
    
    
//     // Validaciones adicionales antes de enviar el formulario
//     const formValid = Object.values(errors).every((value) => value === "");
//     console.log("Estado de newPokemon después de la validación:", newPokemon);
//   console.log("Errores después de la validación:", errors);
